...
802 was devised by the IEEE \nomenclature{IEEE}{Institute of Electrical and Electronic Engineers} LMSC in February, 1980 \cite{intro:ieee_decrypted}, as a project containing working groups that define standard practices and specifications. The 802.11 specification is for implementing WLAN \nomenclature{WLAN}{Wireless Local Area Network} communication at the MAC \nomenclature{MAC}{Media Access Control} level. 

\begin{figure}[htb!]
	\centering\includegraphics{intro/diagrams/tcpip.png}
	\caption{802.11 in the TCP/IP \nomenclature{TCP}{Transmission Control Protocol} \nomenclature{IP}{Internet Protocol} stack.}
\end{figure}

802.11 is split in to various TGs \nomenclature{TG}{Task Group} which define extra amendments to the standard. The most prolific task groups are TGb, TGa, TGg and most recently TGn.
