...
Cyber security has become prevalent in the media over the recent years with whistleblowers \cite{intro:guardian_snowden} providing the general public an insight into just how government agencies across the world, such as GCHQ \cite{intro:gchq_home} \nomenclature{GCHQ}{Government Communication Headquarters} and the NSA \nomenclature{NSA}{National Security Agency} \cite{intro:nsa_home}, have developed software \cite{intro:schneier_nsa_1}\cite{intro:schneier_nsa_3} that allows them to covertly monitor digital communications \cite{intro:schneier_nsa_4}. The software developed, and purchased, takes advantage of zero-day vulnerabilities \cite{intro:nsa_invoice}, and network infrastructure.
...
802 was devised by the IEEE \nomenclature{IEEE}{Institute of Electrical and Electronics Engineers} LMSC \nomenclature{LMSC}{LAN MAN Standards Committee} in February, 1980, as a project containing working groups that define standard practices and specifications. The 802.11 specification is for implementing WLAN communication at the MAC level. 
...
\nomenclature{TCP}{Transport Control Protocol}
\nomenclature{IP}{Internet Protocol}
\nomenclature{MAC}{Media Access Control}
\nomenclature{TG}{Task Group}
\nomenclature{BSS}{Base Service Set}
\nomenclature{BSSID}{Base Service Set Identifier}
\nomenclature{IBSS}{Independent Base Service Set}
\nomenclature{SSID}{Service Set Identifier}
\nomenclature{ESS}{Extended Service Set}
\nomenclature{DS}{Distribution System}
\nomenclature{CRC}{Cyclical Redundancy Check}
\nomenclature{FCS}{Frame Check Sequence}
\nomenclature{IE}{Information Element}
\nomenclature{ERP}{Extended Rate PHY} 
\nomenclature{MITM}{Man In The Middle}
\nomenclature{HTML5}{Hyper-Text Markup Language 5}
\nomenclature{DDMS}{Dalvik Debug Monitor Server}
\nomenclature{GPS}{Global Positioning System}
\nomenclature{MIC}{Message Integrity Check}
\nomenclature{HTTP}{Hyper Text Transfer Protocol}
\nomenclature{HTTPS}{HTTP Secure}
\nomenclature{SSL}{Secure Sockets Layer}
\nomenclature{TSL}{Transport Layer Security}
\nomenclature{MITB}{Man In The Browser}
\nomenclature{BITB}{Boy In The Browser}
\nomenclature{DOS}{Denial Of Service}
\nomenclature{AP}{Access Point}
\nomenclature{DNS}{Domain Name System}
\nomenclature{PNL}{Preferred Network Library}
\nomenclature{IoT}{Internet of Things}
\nomenclature{RSS}{Received Signal Strength}
\nomenclature{GUI}{Graphical User Interface}
\nomenclature{RFC}{Request For Comments}
\nomenclature{WEP}{Wireless Equivalent Policy}
\nomenclature{WLAN}{Wireless Local Area Network}
\nomenclature{WPA}{Wifi Protected Access}
